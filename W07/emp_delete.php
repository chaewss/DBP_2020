...
<body>
    ...
    <form action="emp_delete_process.php" method="POST">
        ...
        <label>gender: &nbsp; &nbsp;
        <input type="radio" name="gender" value="M" <?php if ($row['gender'] != "F") echo "checked"; ?> onclick="return(false);">M
        <input type="radio" name="gender" value="F" <?php if ($row['gender'] == "F") echo "checked"; ?> onclick="return(false);">F
        </label><br>
